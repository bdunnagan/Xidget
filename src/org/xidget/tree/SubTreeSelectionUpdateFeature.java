...
/**
 * A customization of SelectionUpdateFeature that gets the context from the xidget that created the widget
...
{
  public SubTreeSelectionUpdateFeature( IXidget xidget)
  {
    super( xidget);
  }
  
  /* (non-Javadoc)
   * @see org.xidget.feature.model.SelectionUpdateFeature#getContext()
   */
  @Override
