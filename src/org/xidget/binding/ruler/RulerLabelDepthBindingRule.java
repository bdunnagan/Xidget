...
/**
 * An implementation of IBindingRule for specifying the label depth of a ruler instance.
 */
public class RulerLabelDepthBindingRule implements IBindingRule
{
  /* (non-Javadoc)
  ...
  private static final class Listener extends ExpressionListener
  {
    ...
    {
      node = nodes.get( 0);
      IAxisFeature feature = xidget.getFeature( IAxisFeature.class);
      feature.setLabelDepth( Xlate.get( node, -1));
    }
    ...
    public void notifyChange( IExpression expression, IContext context, String newValue, String oldValue)
    {
      ...
      {
        IAxisFeature feature = xidget.getFeature( IAxisFeature.class);
        feature.setLabelDepth( Integer.parseInt( newValue));
      }
      catch( Exception e)
      {
      }
    ...
    {
      IAxisFeature feature = xidget.getFeature( IAxisFeature.class);
      feature.setLabelDepth( (int)newValue);
    }
