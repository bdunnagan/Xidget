...
import org.xidget.ifeature.ITextWidgetFeature.HAlign;
...
/**
 * An implementation of IBindingRule for text horizontal alignment.
 */
public class HAlignBindingRule implements IBindingRule
{
  ...
  private static final class Listener extends ExpressionListener
  {
    ...
    private void update( String alignment)
    {
      ...
      if ( feature != null)
      {
        if ( alignment.equals( "left")) feature.setHAlign( HAlign.left);
        if ( alignment.equals( "center")) feature.setHAlign( HAlign.center);
        if ( alignment.equals( "right")) feature.setHAlign( HAlign.right);
      }
    }
