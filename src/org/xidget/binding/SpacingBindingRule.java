...
/**
 * An implementation of IBindingRule for specifying the spacing between children.
 */
public class SpacingBindingRule implements IBindingRule
{
  ...
  private static final class Listener extends ExpressionListener
  {
    ...
    public void notifyAdd( IExpression expression, IContext context, List<IModelObject> nodes)
    {
      ...
      feature.setSpacing( Xlate.get( node, 2));
    }
    ...
    public void notifyChange( IExpression expression, IContext context, String newValue, String oldValue)
    {
      ...
      {
        IWidgetContainerFeature feature = xidget.getFeature( IWidgetContainerFeature.class);
        feature.setSpacing( Integer.parseInt( newValue));
      }
      catch( Exception e)
      {
      }
    ...
    {
      IWidgetContainerFeature feature = xidget.getFeature( IWidgetContainerFeature.class);
      feature.setSpacing( (int)newValue);
    }
