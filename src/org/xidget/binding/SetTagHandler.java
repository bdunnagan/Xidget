...
/**
 * An implementation of ITagHandler for setting the commit transform of ISingleValueUpdateFeature.
 */
public class SetTagHandler implements ITagHandler
{
  ...
  public boolean enter( TagProcessor processor, ITagHandler parent, IModelObject element) throws TagException
  {
    ...
    if ( expression != null)
    {
      ...
      if ( valueFeature != null) valueFeature.setCommitTransform( expression);
    }
