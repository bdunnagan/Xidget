 ...
 */
public class LogarithmicBindingRule implements IBindingRule
{
  /* (non-Javadoc)
  ...
  private static final class Listener extends ExpressionListener
  {
    ...
    public void notifyAdd( IExpression expression, IContext context, List<IModelObject> nodes)
    {
      ...
      feature.setLogarithmic( Xlate.get( node, 1));
    }
    ...
    public void notifyChange( IExpression expression, IContext context, String newValue, String oldValue)
    {
      ...
      {
        ISliderFeature feature = xidget.getFeature( ISliderFeature.class);
        feature.setLogarithmic( Double.parseDouble( newValue));
      }
      catch( Exception e)
      {
      }
    ...
    {
      ISliderFeature feature = xidget.getFeature( ISliderFeature.class);
      feature.setLogarithmic( newValue);
    }
    ...
    public void notifyValue( IExpression expression, IContext[] contexts, IModelObject object, Object newValue, Object oldValue)
    {
      ...
      {
        ISliderFeature feature = xidget.getFeature( ISliderFeature.class);
        feature.setLogarithmic( Xlate.get( object, 1));
      }
    }
