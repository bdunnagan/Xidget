...
public final class JarResources
{
   ...
   * then tells us whether it could or not. <strong>Example</strong> Let's say you have a JAR file
   * which jarred up a bunch of gif image files. Now, by using JarResources, you could extract,
